...
class Options(object):
    ...
    def __init__(self):
        self.train_data = 'data/cascade.txt'
        self.test_data = 'data/cascadetest.txt'
        self.u2idx_dict = 'data/u2idx.pickle'
        self.idx2u_dict = 'data/idx2u.pickle'
        self.idx2vec_dict = 'data/idx2vec.pickle'
        self.user_data = 'data/users_limited.txt'
        self.save_path = ''
        self.batch_size = 32
        ...
        for line in open(filename):
            ...
            for chunk in chunks:
                try:
                    ...
                    print(chunk)
                if int(user) in self._u2idx:
                    userlist.append(self._u2idx[int(user)])
                    # if len(userlist) > 500:
                    #    break
