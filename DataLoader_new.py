...
class Options(object):
    ...
    def __init__(self):
        ...
        #train file path.
        self.train_data = 'data/weibo/cascade.txt'

        #test file path.
        self.test_data = 'data/weibo/cascadetest.txt'

        self.u2idx_dict = 'data/weibo/u2vec.pickle'

        self.idx2u_dict = 'data/weibo/vec2u.pickle'
        #save path.
        
        self.user_data = 'data/weibo/users_limited.txt'
        self.save_path = ''
...
class DataLoader(object):
    ...
    def _buildIndex(self):
        ...
        user_data = [json.loads(d) for d in open(opt.user_data, "rt").readlines()]
        user_dic={}
